...
<%-- <jsp:include page="../common/manager_topMenu.jsp" flush="false"/> --%>
  ...
  <div class="main">
      <div class="contents">
          <div class="login">
              <form method="post"  action="${contextPath}/manager/manager_login.do">
                  <table class="manager_login" >
                      <tbody>
                          <tr>
                              <td><h1>관리자 로그인</h1></td>
                          </tr>
                          <tr>
                              <td><input type="text" id="id" name="m_id" maxlength="12" placeholder="ID를 입력하세요"/></td>
                          </tr>
                          <tr>
                              <td>
                                  <input type="password" id="pwd" name="m_pwd" maxlength="12" placeholder="PW를 입력하세요"/>
                              </td>
                          </tr>
                          <tr>
                              <td class="options">
